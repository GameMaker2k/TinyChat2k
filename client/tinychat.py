...
login_opener.addheaders = [("Referer", ""+chaturl), ("User-Agent", chatua), ("Accept-Encoding", "gzip, deflate"),
                           ("Accept-Language", "en-US,en-CA,en-GB,en-UK,en-AU,en-NZ,en-ZA,en"), ("Accept-Charset", "utf-8"), ("Accept", "text/plain")]
...
if(re.findall("\{timestamp\:([0-9\.]+)\,userid\:([0-9]+)\,username\:\"(.*)\"\,message\:\"(.*)\"};", welcometext)):
    welcomearray = re.findall(
        "\{timestamp\:([0-9\.]+)\,userid\:([0-9]+)\,username\:\"(.*)\"\,message\:\"(.*)\"};", welcometext)
        ...
        while(chati < chatsize):
            if(re.findall("\{timestamp\:([0-9\.]+)\,userid\:([0-9]+)\,username\:\"(.*)\"\,message\:\"(.*)\"};", chattext[chati])):
                chatarray = re.findall(
                    "\{timestamp\:([0-9\.]+)\,userid\:([0-9]+)\,username\:\"(.*)\"\,message\:\"(.*)\"};", chattext[chati])
